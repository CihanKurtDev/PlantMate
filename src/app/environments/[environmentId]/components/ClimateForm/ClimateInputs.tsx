...
import styles from "./ClimateInputs.module.scss";
...
export const ClimateInputs = ({ climate, onChange, errors, warnings }: ClimateInputsProps) => {
    ...
    return (
        <>
            <fieldset className={styles.tempGroup}>
                <legend className={styles.tempGroupLegend}>Temperatur</legend>
                <Input
